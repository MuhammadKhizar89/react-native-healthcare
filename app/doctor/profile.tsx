      ...
      <View style={styles.mainContent}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.infoCard}>
            ...
            <InfoRow icon="cake" label="Date of Birth" value={userData?.dob || 'Not set'} />
            <InfoRow icon="local-hospital" label="Specialty" value={userData?.specialty || 'Not set'} />
            <InfoRow icon="work" label="Experience" value={userData?.experience ? `${userData.experience} years` : 'Not set'} />
            <InfoRow icon="business" label="Hospital/Clinic" value={userData?.hospital || 'Not set'} />
            <InfoRow icon="info" label="About" value={userData?.about || 'Not set'} noBorder />
          </View>
